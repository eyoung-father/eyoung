...
#define ey_set_file_init(eng, func)									\
	_ey_set_file_init(eng, #func, func, __FILE__, __LINE__)
#define ey_set_file_finit(eng, func)								\
	_ey_set_file_finit(eng, #func, func, __FILE__, __LINE__)
extern int _ey_set_file_init(engine_t engine, const char *function, file_init_handle address, const char *filename, int line);
extern int _ey_set_file_finit(engine_t engine, const char *function, file_finit_handle address, const char *filename, int line);
...
extern int _ey_set_work_init(engine_t engine, int type, const char *function, file_init_handle address, const char *filename, int line);
extern int _ey_set_work_finit(engine_t engine, int type, const char *function, file_init_handle address, const char *filename, int line);
...
extern int _ey_set_event_init(engine_t engine, const char *event, int type, 
	const char *function, file_init_handle address, const char *filename, int line);
