...
typedef int (*ey_zlib_callback)(char *o_buf, size_t o_len, void *arg);
extern int ey_zlib_stream_pack(ey_zlib_t z, char *i_buf, size_t i_len, ey_zlib_callback cb, void *arg);
extern int ey_zlib_stream_unpack(ey_zlib_t z, char *i_buf, size_t i_len, ey_zlib_callback cb, void *arg);
